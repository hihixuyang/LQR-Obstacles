...
#define NUM_QUADS 8			// Number of quadrotors
...
int _tmain(int argc, _TCHAR* argv[]) {
	...
	tempVGoal[0]= 2.0; tempVGoal[1] = 0; tempVGoal[2] = 0;
	vGoalInit.push_back(tempVGoal);
	qlist[0]->setupQuadrotors(xInit, RotInit, Pinit, xGoal, vGoalInit[0], uGoal, RotGoal);
	// Quadrotor 1
	xInit[0] = 4.0; xInit[1] = 0.0; xInit[2] = 2.1;
	xInit[3] = -1.0; xInit[4] = 0.0; xInit[5] = 0;
	tempVGoal[0] = -2.0; tempVGoal[1] = 0.0; tempVGoal[2] = 0;
	vGoalInit.push_back(tempVGoal);
	qlist[1]->setupQuadrotors(xInit, RotInit, Pinit, xGoal, vGoalInit[1], uGoal, RotGoal);
	// Quadrotor 2
	xInit[0] = 0.0; xInit[1] = 4.0; xInit[2] = 2.0;
	xInit[3] = 0.0; xInit[4] = -1.0; xInit[5] = 0;
	tempVGoal[0] = 0.0; tempVGoal[1] = -2.0; tempVGoal[2] = 0.0;
	vGoalInit.push_back(tempVGoal);
	qlist[2]->setupQuadrotors(xInit, RotInit, Pinit, xGoal, vGoalInit[2], uGoal, RotGoal);
	// Quadrotor 3
	xInit[0] = 0.0; xInit[1] = -4.0; xInit[2] = 2;
	xInit[3] = 0.0; xInit[4] = 1.0; xInit[5] = 0;
	tempVGoal[0] = 0.0; tempVGoal[1] = 2.0; tempVGoal[2] = 0;
	vGoalInit.push_back(tempVGoal);
	qlist[3]->setupQuadrotors(xInit, RotInit, Pinit, xGoal, vGoalInit[3], uGoal, RotGoal);
	double arm = sqrt(8.0);
	// Quadrotor 4
	xInit[0] = arm; xInit[1] = arm; xInit[2] = 2;
	xInit[3] = -arm/4.0; xInit[4] = -arm/4.0; xInit[5] = 0;
	tempVGoal[0] = -arm/2.0; tempVGoal[1] = -arm/2.0; tempVGoal[2] = 0;
	vGoalInit.push_back(tempVGoal);
	...
	/*// Quadrotor 8
	xInit[0] = 0.0; xInit[1] = -1.0; xInit[2] = 2;
	xInit[3] = 0.0; xInit[4] = 1.0; xInit[5] = 0;
	tempVGoal[0] = 0.0; tempVGoal[1] = 1.0; tempVGoal[2] = 0;
	vGoalInit.push_back(tempVGoal);
	qlist[8]->setupQuadrotors(xInit, RotInit, Pinit, xGoal, vGoalInit[8], uGoal, RotGoal);
	// Quadrotor 9
	xInit[0] = 0.0; xInit[1] = 1.0; xInit[2] = 2;
	xInit[3] = 0.0; xInit[4] = -1.0; xInit[5] = 0;
	tempVGoal[0] = 0.0; tempVGoal[1] = -1.0; tempVGoal[2] = 0;
	qlist[9]->setupQuadrotors(xInit, RotInit, Pinit, xGoal, vGoalInit[9], uGoal, RotGoal);
	// Quadrotor 10
	xInit[0] = 1.0; xInit[1] = 0.0; xInit[2] = 2;
	xInit[3] = -1.0; xInit[4] =0.0; xInit[5] = 0;
	tempVGoal[0] = -1.0; tempVGoal[1] =0.0; tempVGoal[2] = 0;
	vGoalInit.push_back(tempVGoal);
	qlist[10]->setupQuadrotors(xInit, RotInit, Pinit, xGoal, vGoalInit[10], uGoal, RotGoal);
	// Quadrotor 11
	xInit[0] = -1.0; xInit[1] = 0.0; xInit[2] = 2;
	xInit[3] = 1.0; xInit[4] =0.0; xInit[5] = 0;
	tempVGoal[0] = 1.0; tempVGoal[1] =0.0; tempVGoal[2] = 0;
	vGoalInit.push_back(tempVGoal);
	qlist[11]->setupQuadrotors(xInit, RotInit, Pinit, xGoal, vGoalInit[11], uGoal, RotGoal);*/
		...
		for(size_t i = 0; i  < NUM_QUADS; ++i) {
			...
			for(size_t j = 0; j < NUM_QUADS; ++j) {
				...
				if(i==j);
					...
					sizeObstacle = qlist[i]->reachablePoints.size();
					if(sizeObstacle > 4) {
			...
			//computeHalfPlanes(qlist[i]->x, qlist[i]->vGoal, qlist[i]->newV, distances, normalVectors);
		}
		for(size_t i = 0; i < NUM_QUADS; ++i) {
